...
<div class="top-bg">
    <div class="container">
        ...
        <h2>Add New <b>E Business Card </b></h2>
    </div>
</div>
<div class="container">
                ...
                <div class="row background img-responsive card text-white bg-info mb mb-3">
                    <div class="col-sm-6 col-md-4 leave-top-space">
                        @if(isset($ebusinesscard) && (isset($ebusinesscard->profile) && $ebusinesscard->profile!=''))
                            <div class="person-photo"><div class="main-img"> <img class="profile img-thumbnail" title="profile image" data-toggle="tooltip" src="{{ asset('ebcuploads/profile/'.$ebusinesscard->profile) }}" height="200" alt="Avatar"></div></div>
                        @else
                            <div class="person-photo"><div class="main-img"><img class="profile img-thumbnail" title="profile image" data-toggle="tooltip" src="{{ asset('images/social/avatar.png') }}" height="200" alt="Avatar"></div></div>
                        @endif
                    ...
                    <div class="col-sm-6 col-md-8 leave-top-space" >
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="#" class="twitter social"  href="" target="_blank"><img src="{{ asset('images/social') }}/twitter.svg" width="32" height="32"  title="Twitter" data-alt-src="{{ asset('ebcuploads/social') }}/twitter.png"></a></li>
                                <li><a href="#" class="facebook social"  href="" target="_blank"><img src="{{ asset('images/social') }}/facebook.svg" width="32" height="32"  title="Facebook" data-alt-src="{{ asset('ebcuploads/social') }}/facebook.png"></a></li>
                                <li><a href="#" class="instagram social"  href="" target="_blank"><img src="{{ asset('images/social') }}/instagram.svg" width="32" height="32"  title="Instagram" data-alt-src="{{ asset('ebcuploads/social') }}/instagram.png"></a></li>
                                <li><a href="#" class="whatsapp social"  href="" target="_blank"><img src="{{ asset('images/social') }}/whats-app.svg" width="32" height="32" title="WhatsApp" data-alt-src="{{ asset('ebcuploads/social') }}/whats-app.png"></a></li>
                                <li><a href="#" class="meetup social"  href="" target="_blank"><img src="{{ asset('images/social') }}/meetup.svg" width="32" height="32"  title="Meetup" data-alt-src="{{ asset('ebcuploads/social') }}/meetup.png"></a></li>
                                <li><a href="#" class="snapchat social"  href="" target="_blank"><img src="{{ asset('images/social') }}/snapchat.svg" width="32" height="32"  title="Snapchat" data-alt-src="{{ asset('ebcuploads/social') }}/snapchat.png"></a></li>
                                <li><a href="#" class="google social" href="" target="_blank"><img src="{{ asset('images/social') }}/google-plus.svg" width="32" height="32"   title="Google+" data-alt-src="{{ asset('ebcuploads/social') }}/google-plus.png"></a></li>
                                <li><a href="#" class="linkedin social" href="" target="_blank"><img src="{{ asset('images/social') }}/linked-in.svg" width="32" height="32"   title="LinkedIn" data-alt-src="{{ asset('ebcuploads/social') }}/linked-in.png"></a></li>
                                <li><a href="#" class="foursquare social"  href="" target="_blank"><img src="{{ asset('images/social') }}/foursquare.svg" width="32" height="32"  title="Foursquare" data-alt-src="{{ asset('ebcuploads/social') }}/foursquare.png"></a></li>
                                <li><a href="#" class="wordpress social"  href="" target="_blank"><img src="{{ asset('images/social') }}/wordpress.svg" width="32" height="32"  title="Blog" data-alt-src="{{ asset('ebcuploads/social') }}/wordpress.png"></a></li>
                                <li><a href="#" class="youtube social"  href="" target="_blank"><img src="{{ asset('images/social') }}/youtube.svg" width="32" height="32"  title="YouTube" data-alt-src="{{ asset('ebcuploads/social') }}/youtube.png"></a></li>
                                <li><a href="#" class="pinterest social"  href="" target="_blank"><img src="{{ asset('images/social') }}/pinterest.svg" width="32" height="32"  title="Pinterest" data-alt-src="{{ asset('ebcuploads/social') }}/pinterest.png"></a></li>
                            </ul>
                        </div>
                        <h4 id='name'></h4>
    ...
    <div class="row">
        ...
        <div class="well well-sm">
            ...
            @if(isset($ebusinesscard) && $ebusinesscard!='')
                {{ Form::model($ebusinesscard, ['route' => ['ebusinesscard.update', $ebusinesscard->id], 'method' => 'patch','id'=>'ecardformID12','enctype'=>"multipart/form-data",'files' => true]) }}
            @else
                {!! Form::open(['route' => 'ebusinesscard.store','id'=>'ecardformID']) !!}
...
@else
    <script>
        $('.background').css({'background-image':'url({{ asset('images/social/background.jpeg') }})','background-size':'100% 100%'});
    </script>
@endif
